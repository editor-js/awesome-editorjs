...
* [frappeframework.com](https://frappeframework.com/docs/v14/user/en/desk/workspace#workspace-blocks) - A meta data based framework which has workspace feature which uses Editor.js 
