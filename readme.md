...
* [editorjs-text-background-color-plugin](https://github.com/Faqahat/editorjs-text-background-color-plugin) - Text and background color plugin like Notion for inline tools.
